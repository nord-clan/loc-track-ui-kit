...
export const ModalStyled = styled.div`
  .modal-content {
    ...
    border-radius: 14px;
    background: ${({ theme }) => theme.palette?.bg.modal ?? defaultTheme.palette.bg.modal};
    border-left: 8px solid
      ${({ theme }) => theme.palette?.bg.highlight ?? defaultTheme.palette.bg.highlight};
    color: ${({ theme }) =>
      theme.palette?.color.textInvert ?? defaultTheme.palette.color.textInvert};
    ...
    &.processing {
      box-shadow: -10px 0 10px -10px ${({ theme }) => theme.palette?.bg.highlight ?? defaultTheme.palette.bg.highlight},
  ...
  .button {
    background-color: ${({ theme }) =>
      theme.palette?.bg.modalContent ?? defaultTheme.palette.bg.modalContent};
    border: 1px solid
      ${({ theme }) => theme.palette?.border.content ?? defaultTheme.palette.border.content};
    color: ${({ theme }) =>
      theme.palette?.color.textInvert ?? defaultTheme.palette.color.textInvert};
  }
